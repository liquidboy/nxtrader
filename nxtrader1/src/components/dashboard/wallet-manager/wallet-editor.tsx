  ...
  return (<div>
   <div id="walletEditor" className="oj-sm-margin-4x-start oj-sm-padding-3x" hidden>
      <oj-validation-group id="tracker" valid={groupValid.value}>
        <oj-form-layout>
          <oj-input-text id="wn" required={true} label-hint="wallet name"></oj-input-text>
          <oj-input-password id="wpk" required={true} label-hint="public key" mask-icon="visible"></oj-input-password>
