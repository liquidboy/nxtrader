...
export declare const getN3AddressBalances: (address: string) => Promise<Asset[]>;
export declare const handleN3TxResponse: (data: any) => Promise<Transaction[]>;
export declare const getN3AssetTxs: (address: string, asset: string) => Promise<Transaction[]>;
export declare const getN3AllTxs: (address: string) => Promise<Transaction[]>;
export declare const loadWalletsFromStoragePK: () => Array<CWallet>;
...
export declare const getSelectedTagsFromStorage: () => Array<string>;
export declare const saveSelectedTagsToStorage: (tags: Array<string>) => void;
...
export declare const addressFormat: (address: string) => string;
export {};
