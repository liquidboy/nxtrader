define(["require", "exports", "preact/jsx-runtime", "ojs/ojvcomponent", "css!dashboard/bot-maintainer/bot-maintainer-styles.css"], function (require, exports, jsx_runtime_1, ojvcomponent_1) {
    ...
    function BotMaintainerImpl({ message = "Hello from  dashboard-bot-maintainer" }) {
    ...
    exports.BotMaintainer = (0, ojvcomponent_1.registerCustomElement)("dashboard-bot-maintainer", BotMaintainerImpl, "BotMaintainer", { "properties": { "message": { "type": "string" } } }, { "message": "Hello from  dashboard-bot-maintainer" });
});
