define(["require", "exports", "preact/jsx-runtime", "ojs/ojarraydataprovider"], function (require, exports, jsx_runtime_1, ArrayDataProvider) {
    ...
    function ChartItem(props) {
        ...
        return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("oj-chart", Object.assign({ id: props.id, type: "pyramid", data: chartDataProvider, "animation-on-display": "auto", "animation-on-data-change": "auto" }, { children: (0, jsx_runtime_1.jsx)("template", { slot: "itemTemplate", "data-oj-as": "item", render: (item) => {
